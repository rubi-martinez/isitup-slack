...
* Under "Choose a command", enter whatever you want for the comand. 
/isitup is easy to remember. 
*Under "URL", enter the URL for the script on your server. 
*Leave "Method" set to "Post".
*Decide whether you want this command to show in the autocomplete list 
for slash commands. 
*If you do, enter a short description and usage hint. 

"""

#Replace this with the token from your slash command configuartion page: 
TOKEN = os.environ['ACCESS_TOKEN']

@aap.route('/isitup', methods=['POST'])
def isitiup(): 
    ...
    if request.form['token'] == TOKEN: 
        ...
        r = requests.get('https://isitup.org/' + requests.form['text'] + '.json', headers=headers)
        ...
        if not r.status_code:
        	...
        	reply = "Sorry, isitup could not be reached."
